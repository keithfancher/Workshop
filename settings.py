...
DATABASE_NAME = os.path.join(os.path.dirname(__file__), 'devel.sqlite3').replace('\\','/')            # Or path to database file if using sqlite3.
...
SECRET_KEY = '3e38o@-vw691uwe%lgk+ckg=+04^bq6u7)t4##wkrohi#5!ziw'
